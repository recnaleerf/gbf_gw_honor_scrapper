...
@scrapper_controller.route('/api/scrape/<news_source>/<ticker_symbol>', methods=['POST'])
...
@scrapper_controller.route('/api/get_company_name/<ticker_symbol>', methods=['GET'])
...
@scrapper_controller.route('/api/get_company_suggestion/<ticker_symbol>', methods=['GET'])
